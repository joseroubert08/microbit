...
public class AudioPlugin
{
    ...
    //alternate between START and STOP, this enum is necessary because state of AudioPlugin
    //is not preserved i.e. isRecording() is always false if called within BLEService
    public static final int TOOGLE_RECORD = 3;
